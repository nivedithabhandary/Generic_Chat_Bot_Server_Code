...
class Tweepy(object):
    ...
    def __init__(self, mongo):
        ...
        consumer_key = "IDw76l5OP7OgYcPlPVxy0iHjY"
        consumer_secret = "ztklfExcOUZb1AOC7BZsWx9AMlmBqr86XWcm21bPdIZ7xNhWwU"
        access_token = "4893788286-8nLeAXZ98jtMGyjAtuWfKyLZmZ9lXYbjsxGEd2a"
        access_token_secret = "ZC8VvoMbBWVPtSTxOUWHYqsfObmtxCJyj2oIAZLNV6qBm"
    ...
    def get_user_tweets(self, screen_name, max_count=3200):
        ...
        # This method can only return up to 3200 of a users most recent Tweets. Native retweets of other statuses by the user is included in this total, regardless of whether include_rts is set to false when requesting this resource.
